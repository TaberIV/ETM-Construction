...
export default () => {
  const photos = [
    ...
    { src: "meridian/Meridian.jpg", heading: "Meridian" },
    { src: "meridian/Meridian3.jpg", heading: "Meridian3" },
    ...
    {
      src: "kelly/001-Front_View-5688603-large.jpg",
      heading: "Kelly_Front_View"
    },
